		...
		try:
			...
			if iter_num == epoch_length:
				...
				if C.verbose:
					...
					lr['cls'].append(loss_rpn_cls)
					lr['regr'].append(loss_rpn_regr)
					lc['cls'].append(loss_class_cls)
					lc['regr'].append(loss_class_regr)
...
lr = pd.DataFrame(lr)
lc = pd.DataFrame(lc)
lr.to_csv('./rpn_loss_newmodel.csv', index=False)
lc.to_csv('./class_loss_newmodel.csv', index=False)
